...
class DataGovernanceController {
    ...
    static async exportUserData(req, res) {
        ...
        try {
            ...
            await audit_1.AuditService.log(actor.id, 'UPDATE', 'USER', userIdToExport, {
    ...
    static async deleteUser(req, res) {
        ...
        try {
            ...
            if (financialRecordsCount > 0) {
                ...
                await audit_1.AuditService.log(actor.id, 'UPDATE', 'USER', userIdToDelete, {
                    oldData,
                    newData: updatedUser,
                    ip: req.ip,
                    userAgent: req.headers['user-agent']
                ...
                await audit_1.AuditService.log(actor.id, 'DELETE', 'USER', userIdToDelete, {
                    oldData,
                    ip: req.ip,
                    userAgent: req.headers['user-agent']
                });
...
const dataGovernanceRouter = express_1.default.Router();
dataGovernanceRouter.get('/user/:id/export', middleware_js_1.requireAuth, DataGovernanceController.exportUserData);
dataGovernanceRouter.post('/user/:id/delete', middleware_js_1.requireAuth, DataGovernanceController.deleteUser);
exports.default = dataGovernanceRouter;
