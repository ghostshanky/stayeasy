...
router.get('/chats', middleware_js_1.requireAuth, async (req, res) => {
    try {
...
router.get('/chats/:chatId/messages', middleware_js_1.requireAuth, async (req, res) => {
    try {
...
router.post('/chats/:chatId/messages', middleware_js_1.requireAuth, async (req, res) => {
    try {
        const { chatId } = req.params;
...
// Start a new chat
router.post('/chats', middleware_js_1.requireAuth, async (req, res) => {
    try {
...
router.post('/chats/:chatId/read', middleware_js_1.requireAuth, async (req, res) => {
    try {
        const { chatId } = req.params;
