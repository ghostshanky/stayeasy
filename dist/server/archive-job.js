...
exports.RETENTION_POLICIES = void 0;
exports.runArchiveJob = runArchiveJob;
exports.getChatMetrics = getChatMetrics;
exports.cleanupOrphanedData = cleanupOrphanedData;
const client_1 = require("@prisma/client");
const chat_1 = require("./chat");
const prisma = new client_1.PrismaClient();
const archiver = new chat_1.ChatArchiver();
...
*/
// Monitoring queries
async function getChatMetrics() {
    const [totalMessages, totalChats, activeChats, unreadMessages] = await Promise.all([
