...
async function main() {
    ...
    try {
        ...
        const adminPassword = await auth_js_1.AuthService.hashPassword('admin123');
        ...
        const owner1Password = await auth_js_1.AuthService.hashPassword('owner123');
        ...
        const owner2Password = await auth_js_1.AuthService.hashPassword('owner456');
        ...
        const ownerAccountPassword = await auth_js_1.AuthService.hashPassword('owner123');
        ...
        const owner3Password = await auth_js_1.AuthService.hashPassword('owner789');
        ...
        const owner4Password = await auth_js_1.AuthService.hashPassword('owner101');
        ...
        const tenant1Password = await auth_js_1.AuthService.hashPassword('tenant123');
        ...
        const tenant2Password = await auth_js_1.AuthService.hashPassword('tenant456');
        ...
        const tenant3Password = await auth_js_1.AuthService.hashPassword('tenant789');
